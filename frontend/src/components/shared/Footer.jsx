...
import aiLogo from "@/assets/ai_black.png";
    ...
    <footer className="border-t border-t-gray-200 py-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <a href="https://virtual-interview-tool-d5jbehpunk6dazqbikopyo.streamlit.app/" className="hover:text-gray-400" aria-label="AI Logo">
